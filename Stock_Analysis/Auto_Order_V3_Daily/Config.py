...
class Functions:
    ...
    def get_klines(self):
        ...
        # Compute EMA
        dataframe["EMA"] = dataframe['open'].ewm(span=70, adjust=False, min_periods=70).mean()

        # Compute RSI
        dataframe["RSI"] = pta.rsi(dataframe['open'], length=12)
        ...
        # Compute BBands
        bbands_dataframe = pta.bbands(dataframe['open'], length=70, std=1.3)
