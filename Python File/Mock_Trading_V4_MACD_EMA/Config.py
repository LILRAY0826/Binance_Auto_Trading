...
class Functions:
    ...
    def get_klines(self, start_date, end_date, interval, ema):
        ...
        self.kline_dataframe['EMA'] = self.kline_dataframe['close'].ewm(span=ema, adjust=False, min_periods=ema).mean()
        self.kline_dataframe['RSI'] = pta.rsi(self.kline_dataframe['close'], length=12)
        ...
        for index, row in self.kline_dataframe.iterrows():
            ...
            if boolean and start_property > buy:
                ...
                if "多" in entry_direction and len(long_position) < max_number_of_position:
                    ...
                    if entry_price > ema_price and 70 > rsi_value > 50:
                        trading_number += 1
                        start_property -= buy
                ...
                # Short Position
                    ...
                    liquidation = round(entry_price * (1 + (100 / leverage) / 100), 2)
                    profit_price = entry_price - profit_range
                    if entry_price < ema_price and 30 < rsi_value < 50:
                        trading_number += 1
                        start_property -= buy
